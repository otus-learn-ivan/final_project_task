...
protected:
    static boost::asio::io_service& get_ios() {
        ...
        static boost::asio::signal_set signals{ios, SIGINT, SIGTERM};
        signals.async_wait([&](auto, auto) { ios.stop(); });
        return ios;
    }
public:
    template <class T>
...
class tasks_processor: public  detail::tasks_processor {
    // ...
...
const unsigned short g_port_num = 9000;//65001;
